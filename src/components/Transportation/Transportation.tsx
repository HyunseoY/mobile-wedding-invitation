      ...
      <Styled.Transportation>
          ...
          <FlexColumn gap={20} padding="10px 0">
            ...
            <FlexColumn gap={7}>
              ...
              <Flex align="center">
                ...
                <Text fontSize="13px" color="content2" text="2호선 전포역 3번 출구에서 도보 5분" />
              </Flex>
            </FlexColumn>
          </FlexColumn>
        </Fade>
        ...
        <Fade direction="up" triggerOnce={true} fraction={0.01}>
          <FlexColumn gap={20} padding="10px 0">
            ...
            <FlexColumn gap={7}>
              <Text fontSize="13px" color="realBlack" text="서면 한전 (범내골 방면) 하차" />
              <Text
                fontSize="13px"
                color="content2"
              ...
              <Flex align="center">
                <Styled.Dott color="orange" />
                <Text fontSize="13px" color="content2" text="심야 : 1000, 1004, 1010" />
              </Flex>
            </FlexColumn>
            ...
            <FlexColumn gap={7}>
              <Text fontSize="13px" color="realBlack" text="경남공고 (서면 한전 방면) 하차" />
            ...
            <FlexColumn gap={7}>
              <Text fontSize="13px" color="realBlack" text="경남공고 (부전도서관 방면) 하차" />
              <Text
                fontSize="13px"
                color="content2"
        ...
        <Fade direction="up" triggerOnce={true} fraction={0.01}>
          <FlexColumn gap={20} padding="10px 0">
            ...
            <FlexColumn gap={7}>
              <Flex align="center">
                <Styled.Dott />
                <Text fontSize="13px" color="content2" text="네비게이션 : '헤리움 웨딩홀' 검색" />
              </Flex>
              <Text fontSize="13px" color="content2" margin="12px" text={`• 주소검색`} />
              <Text
                fontSize="13px"
                color="content2"
                margin="22px"
              ...
              />
              <Text fontSize="13px" color="content2" margin="22px" text={`'부전동 537-9' 입력`} />
            </FlexColumn>
