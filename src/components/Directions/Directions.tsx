import { faLock, faLockOpen, faMapLocationDot } from "@fortawesome/free-solid-svg-icons";
    ...
    <>
      ...
      <Fade direction="up" triggerOnce={true} fraction={0.01}>
        <FlexColumn align="center" marginTop={35} gap={15}>
          ...
          <Text fontSize="16px" color="gray6" text="부산 부산진구 중앙대로 666번길 50" />

          <Styled.Text fontSize="14px" color="gray5" style={{ marginTop: "15px" }}>
            Tel. 051-943-1004
          </Styled.Text>
        </FlexColumn>
      </Fade>
